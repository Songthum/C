                                            ...
                                            {tableData.length > 0 ? (
                                                tableData.map((row, index) => (
                                                    <TableRow key={index}>
                                                        ...
                                                        <TableCell>{row.P_S1}<br/>{row.P_S2}</TableCell>
                                                        <TableCell>
                                                            <Button onClick={() => handlePopupClick(row)}>ดูรายละเอียด</Button>
                                                        </TableCell>
                                                        <TableCell>
                                                            <Button onClick={() => handleOpenAcceptDialog(row)}>รับเป็นที่ปรึกษา</Button><br/><Button onClick={() => handleOpenRejectDialog(row)}>ไม่รับเป็นที่ปรึกษา</Button>
